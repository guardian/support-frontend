...
const stateMachineYaml = Mustache.render(stateMachine, {}, {sequentialRetries: loadTemplate('sequential-retries.yaml'), parallelRetries: loadTemplate('parallel-retries.yaml')});
