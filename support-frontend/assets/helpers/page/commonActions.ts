...
export type Action = SetCountryAction | {
...
// ----- Exports ----- //
export { setCountry, setExistingPaymentMethods, setContributionTypes, setUseLocalCurrencyFlag, setCurrencyId, setUseLocalAmounts };