...
export type Action =
  ...
  | { type: 'SET_EXISTING_PAYMENT_METHODS', existingPaymentMethods: ExistingPaymentMethodsResponse }
...
function setExistingPaymentMethods(existingPaymentMethods: ExistingPaymentMethodsResponse): Action {
