...
import { type CountryGroup, type CountryGroupId, countryGroups, fromCountry } from "./countryGroup";
import type { IsoCountry } from "./country";
// ----- Types ----- //
export type IsoCurrency = "GBP" | "USD" | "AUD" | "EUR" | "NZD" | "CAD" | "SEK" | "CHF" | "NOK" | "DKK";
...
// ----- Functions ----- //
function fromCountryGroupId(countryGroupId: CountryGroupId): IsoCurrency | null | undefined {
  const countryGroup: CountryGroup | null | undefined = countryGroups[countryGroupId];
...
function currencyFromCountryCode(countryCode: IsoCountry): IsoCurrency | null | undefined {
...
// ----- Exports ----- //
export { detect, spokenCurrencies, fromCountryGroupId, currencyFromCountryCode, currencies, glyph, extendedGlyph, isSuffixGlyph, isPaddedGlyph };