...
export function gridUrl(gridId: ImageId, size: number, imgType: ImageType = 'jpg'): string {
...
export function gridSrcset(gridId: ImageId, sizes: number[], imgType?: ImageType): string {
