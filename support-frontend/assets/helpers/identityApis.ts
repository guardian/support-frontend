...
function canContributeWithoutSigningIn(contributionType: ContributionType, isSignedIn: boolean, userTypeFromIdentityResponse: UserTypeFromIdentityResponse) {
  return contributionType === 'ONE_OFF' || isSignedIn || userTypeFromIdentityResponse === 'guest' || userTypeFromIdentityResponse === 'new';
}
