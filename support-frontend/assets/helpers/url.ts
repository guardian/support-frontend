...
// ----- Exports ----- //
export { getQueryParameter, getAllQueryParams, getAllQueryParamsWithExclusions, getOrigin, getBaseDomain, addQueryParamsToURL, getAbsoluteURL, getPathAfterRoute, isProd };