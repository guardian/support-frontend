...
describe('theGrid', () => {
	it('should construct a grid url from original grid image', () => {
		...
		const size = 333;
		const expectedUrl = `${GRID_DOMAIN}/img/media/0e5187e523a6445003fae7b1bb4124a8a4a814c8/0_655_6362_2706/master/6362.jpg?dpr=1&s=none&width=333`;
	...
	it('should construct a srcset of grid urls', () => {
		...
		const expectedSrcset = `${urlPath}/6362.jpg?dpr=1&s=none&width=300 300w, ${urlPath}/6362.jpg?dpr=1&s=none&width=500 500w`;
