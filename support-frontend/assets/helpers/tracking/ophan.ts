...
import { Participations, TestId } from "helpers/abTests/abtest";
...
const buildOphanPayload = (participations: Participations): OphanABPayload => Object.keys(participations).reduce((payload, participation) => {
...
const trackAbTests = (participations: Participations): void => ophan.record({
...
export { trackComponentEvents, pageView, trackAbTests, setReferrerDataInLocalStorage };