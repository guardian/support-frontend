// ----- Imports ----- //
import { derivePaymentApiAcquisitionData, getOphanIds, participationsToAcquisitionABTest } from "../acquisitions";
// ----- Tests ----- //
jest.mock('ophan', () => ({
  viewId: '123456'
}));
describe('acquisitions', () => {
  describe('derivePaymentApiAcquisitionData', () => {
    it('should return a PaymentAPIAcquisitionData correctly built', () => {
      ...
      const paymentApiAcquisitionData = derivePaymentApiAcquisitionData(referrerAcquisitionData, nativeAbParticipations);
