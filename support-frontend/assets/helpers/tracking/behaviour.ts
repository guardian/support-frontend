...
const trackCheckoutSubmitAttempt = (componentId: string, eventDetails: string, paymentMethod: PaymentMethod | null | undefined, productCheckout: ProductCheckout): void => {
  gaEvent({
    category: 'click',
    action: eventDetails,
    label: componentId
...
const trackThankYouPageLoaded = (productCheckout: SubscriptionProduct, paymentMethod: PaymentMethod | null | undefined) => {
  gaEvent({
...
export { trackThankYouPageLoaded, trackComponentClick, trackCheckoutSubmitAttempt, trackComponentLoad };