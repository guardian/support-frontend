...
export type Action = {
  ...
  addDigital: boolean;
} | AddressAction | PayPalAction | DDAction;

// ----- Action Creators ----- //
const setStage = (stage: Stage, product: SubscriptionProduct, paymentMethod: PaymentMethod | null | undefined): Action => {
...
const formActionCreators = {
  ...
  setFirstName: (firstName: string): (...args: Array<any>) => any => setFormSubmissionDependentValue(() => ({
    type: 'SET_FIRST_NAME',
    firstName
  })),
  setLastName: (lastName: string): (...args: Array<any>) => any => setFormSubmissionDependentValue(() => ({
    type: 'SET_LAST_NAME',
    lastName
  })),
  setEmail: (email: string): (...args: Array<any>) => any => setFormSubmissionDependentValue(() => ({
    type: 'SET_EMAIL',
    email
  })),
  setConfirmEmail: (email: string): (...args: Array<any>) => any => setFormSubmissionDependentValue(() => ({
    type: 'SET_CONFIRM_EMAIL',
    email
  })),
  ...
  setFirstNameGift: (firstNameGiftRecipient: string): (...args: Array<any>) => any => setFormSubmissionDependentValue(() => ({
    type: 'SET_FIRST_NAME_GIFT',
    firstNameGiftRecipient
  })),
  setLastNameGift: (lastNameGiftRecipient: string): (...args: Array<any>) => any => setFormSubmissionDependentValue(() => ({
    type: 'SET_LAST_NAME_GIFT',
    lastNameGiftRecipient
  })),
  setEmailGift: (emailGiftRecipient: string): (...args: Array<any>) => any => setFormSubmissionDependentValue(() => ({
    type: 'SET_EMAIL_GIFT',
    emailGiftRecipient
  })),
  ...
  onPaymentAuthorised: (authorisation: PaymentAuthorisation) => (dispatch: Dispatch<Action>, getState: () => CheckoutState) => {
    const state = getState();
...
export { setStage, setFormErrors, setSubmissionError, setFormSubmitted, setUserTypeFromIdentityResponse, formActionCreators };