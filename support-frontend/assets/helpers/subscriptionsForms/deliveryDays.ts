...
const getNextDeliveryDay = (previousDeliveryDay: Date) => new Date(previousDeliveryDay.getTime() + 7 * milsInADay);
...
export { jsDayToFulfilmentDay, getDeliveryDays, getNextDeliveryDay, DeliveryDays };