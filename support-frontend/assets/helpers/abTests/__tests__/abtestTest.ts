...
it('targetPage matching', () => {
	...
	expect(
		targetPageMatches('/uk/subscribe/digital', nonGiftLandingAndCheckout),
	).toEqual(true);
	expect(
		targetPageMatches('/subscribe/digital/checkout', nonGiftLandingAndCheckout),
	).toEqual(true);
	expect(
		targetPageMatches('/uk/subscribe/digital/gift', nonGiftLandingAndCheckout),
	).toEqual(false);
