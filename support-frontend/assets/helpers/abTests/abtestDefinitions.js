...
export const pageUrlRegexes = {
  ...
  subscriptions: {
    ...
    digiSub: {
      ...
      // Requires /subscribe/digital, allows /checkout or /checkout/guest, allows any query string
      nonGiftLandingWithGuestCheckout: /\/subscribe\/digital(\/checkout|\/checkout\/guest)?(\?.*)?$/,
    },
  },
};
