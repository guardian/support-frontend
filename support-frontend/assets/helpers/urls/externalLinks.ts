...
function getDigitalCheckout(countryGroupId: CountryGroupId, billingPeriod: DigitalBillingPeriod | DigitalGiftBillingPeriod, promoCode: Option<string>, orderIsAGift: boolean, isUsingGuestCheckout: boolean): string {
  const params = new URLSearchParams(window.location.search);
