...
import { DigitalBillingPeriod, DigitalGiftBillingPeriod } from "helpers/productPrice/billingPeriods";
...
function getLegacyPaperAndDigitalLink(countryGroupId: CountryGroupId, intCmp: string | null | undefined, referrerAcquisitionData: ReferrerAcquisitionData, nativeAbParticipations: Participations) {
...
// ----- Exports ----- //
export { getLegacyPaperAndDigitalLink, getMemLink, getPatronsLink, getDigitalCheckout, getIosAppUrl, androidAppUrl, androidDailyUrl, getDailyEditionUrl, getSignoutUrl, getReauthenticateUrl, myAccountUrl, manageSubsUrl, homeDeliveryUrl, helpCentreUrl, emailPreferences };