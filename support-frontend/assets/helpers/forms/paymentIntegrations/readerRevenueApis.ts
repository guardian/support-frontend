 ...
 */
function checkRegularStatus(participations: Participations, csrf: CsrfState): (arg0: Record<string, any>) => Promise<PaymentResult> {
...
function postRegularPaymentRequest(uri: string, data: RegularPaymentRequest, participations: Participations, csrf: CsrfState): Promise<PaymentResult> {
...
export { postRegularPaymentRequest, regularPaymentFieldsFromAuthorisation, PaymentSuccess };