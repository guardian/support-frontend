...
const getAmazonRegion = (countryGroupId: CountryGroupId, amazonLoginObject: Record<string, any>): string | null | undefined => {
...
const getAmazonPayClientId = (isSandbox: boolean): string => isSandbox ? window.guardian.amazonPayClientId.uat : window.guardian.amazonPayClientId.default;

// Amazon Pay callbacks - called after Widgets.js has loaded
const setupAmazonPayCallbacks = (countryGroupId: CountryGroupId, dispatch: (...args: Array<any>) => any, isSandbox: boolean): void => {
...
const loadAmazonPayScript = (isSandbox: boolean): void => {
  ...
  const widgetsUrl = isSandbox ? 'https://static-na.payments-amazon.com/OffAmazonPayments/us/sandbox/js/Widgets.js' : 'https://static-na.payments-amazon.com/OffAmazonPayments/us/js/Widgets.js';
...
const setupAmazonPay = (countryGroupId: CountryGroupId, dispatch: (...args: Array<any>) => any, isTestUser: boolean): void => {
