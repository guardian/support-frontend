...
export type ErrorReason = "insufficient_funds" | "payment_details_incorrect" | "personal_details_incorrect" | "payment_method_temporarily_declined" | "payment_method_unacceptable" | "payment_provider_unavailable" | "payment_recently_taken" | "all_payment_methods_unavailable" | "invalid_form_mobile" | "marketing_consent_api_error" | "incompatible_payment_method_and_contribution_type" | "internal_error" | "card_authentication_error" | "incomplete_payment_request_details" | "amazon_pay_try_other_card" | "amazon_pay_try_again" | "amazon_pay_fatal" | "unknown";
