...
import { CountryGroup, CountryGroupId } from "helpers/internationalisation/countryGroup";
...
export const isValidIban = (iban: string | null): boolean => !!iban && /[a-zA-Z]{2}[0-9]{2}[a-zA-Z0-9]{4}[0-9]{7}([a-zA-Z0-9]?){0,16}/.test(iban);