...
import { DigitalPack, GuardianWeekly, Paper } from "helpers/subscriptions";
...
import { DirectDebit, ExistingCard, ExistingDirectDebit, PayPal, Stripe, AmazonPay } from "helpers/paymentMethods";
...
export type RegularPaymentFields = RegularPayPalPaymentFields | RegularStripePaymentIntentFields | RegularDirectDebitPaymentFields | RegularExistingPaymentFields | CorporateRedemption | RegularAmazonPayPaymentFields;
...
export type PaymentAuthorisation = StripePaymentIntentAuthorisation | PayPalAuthorisation | DirectDebitAuthorisation | ExistingCardAuthorisation | ExistingDirectDebitAuthorisation | AmazonPayAuthorisation;
