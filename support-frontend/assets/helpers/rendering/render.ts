...
const getElement = (id: string): HTMLElement | null | undefined => document.getElementById(id);
...
const renderError = (e: Error, id: string | null | undefined) => {
  ...
  import('pages/error/components/errorPage').then(({
    default: ErrorPage
  }) => {
    if (element) {
...
const renderPage = (content: Record<string, any>, id: string, callBack?: () => void) => {
