...
function pollUntilPromise<A>(max: number, sleep: number, p: () => Promise<A>, pred: (arg0: A) => boolean): Promise<A> {
...
function bracketPromise<A, B>(acquire: () => Promise<A>, release: (arg0: A) => Promise<void>, use: (arg0: A) => Promise<B>): () => Promise<B> {
...
export { repeatPromise, sleepPromise, pollUntilPromise, logPromise, bracketPromise };