...
class WeeklyCheckoutForm extends Component<PropTypes> {
  ...
  render() {
    ...
    const fulfilmentOption = getFulfilmentOption(deliveryCountry);
    const price = regularPrice(productPrices, billingCountry, billingPeriod, fulfilmentOption);
    const promotion = getPromotion(productPrices, billingCountry, billingPeriod, fulfilmentOption);
