...
function ThankYouGift(props: PropTypes) {
	...
	const fullDate = date
		? formatUserDate(date)
		: 'Date chosen by you at checkout';
	return (
				...
				>
						...
						<div css={blueSans}>
							{props.pending
								? `Your digital subscription order ${
								  ...
								  } has been placed and is pending confirmation`
								: `Your digital subscription order ${
										props.giftRecipient ? `for ${props.giftRecipient}` : ''
					...
					<PageSection>
						...
						<div css={detailsWithIcon}>
							...
							<div css={summaryDetails}>
								...
								<div css={sansText}>
									The Guardian Editions app, Premium access to the Guardian Live
									app and ad-free reading on theguardian.com
								</div>
							</div>
						</div>
					</PageSection>
					<PageSection>
						...
						<ul>
							...
							<li>
								<div css={blueLineContainer}>
									<div css={blueLinkLine} />
								</div>
							</li>
							<li css={detailsWithIconList}>
								<div css={iconContainer}>
					...
					<PageSection>
						...
						<div css={sansText}>
							...
							the most of your digital subscription, receive a dedicated weekly
							email from our membership editor and get more information on ways
