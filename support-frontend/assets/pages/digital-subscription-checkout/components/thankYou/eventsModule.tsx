...
const EventsModule = () => <div>
    ...
    <Text title="Guardian digital events">
      ...
      <LinkButton css={marginForButton} priority="tertiary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon aria-label="Click to find out more about Guardian Live events and Masterclasses" href={getMemLink('events')} onClick={sendTrackingEventsOnClick({
      ...
      <LinkButton css={marginForButton} priority="tertiary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon aria-label="Click to manage your email subscriptions, and sign up to receive news about Guardian Live events and Masterclasses" href={emailPreferences} onClick={sendTrackingEventsOnClick({
