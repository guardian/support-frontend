...
import { getIosAppUrl, androidAppUrl, androidDailyUrl, getDailyEditionUrl } from "helpers/urls/externalLinks";
...
const AppsSection = ({
  countryGroupId
    ...
    <Text title="Download the Guardian Editions app" headingSize={3}>
      ...
      <div css={ctas}>
        <ThemeProvider theme={buttonReaderRevenueBrandAlt}>
          <LinkButton css={marginForFirstButton} priority="tertiary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon aria-label="Click to download the Guardian Daily app on the Apple App Store" href={getDailyEditionUrl(countryGroupId)} onClick={sendTrackingEventsOnClick({
          ...
          <LinkButton priority="tertiary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon aria-label="Click to download the Guardian Daily app on Google Play" href={androidDailyUrl} onClick={sendTrackingEventsOnClick({
    ...
    <Text title="Download the Guardian Live app" headingSize={3}>
      ...
      <div css={ctas}>
        <ThemeProvider theme={buttonReaderRevenueBrandAlt}>
          <LinkButton css={marginForFirstButton} priority="tertiary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon aria-label="Click to download the app on the Apple App Store" href={getIosAppUrl(countryGroupId)} onClick={sendTrackingEventsOnClick({
          ...
          <LinkButton priority="tertiary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon aria-label="Click to download the app on the Google Play store" href={androidAppUrl} onClick={sendTrackingEventsOnClick({
    ...
    <Text title="Sign into theguardian.com">
      ...
      <ThemeProvider theme={buttonReaderRevenueBrandAlt}>
        <LinkButton css={marginForFirstButton} priority="tertiary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon aria-label="Click to sign in to the website" href="https://www.theguardian.com/" onClick={sendTrackingEventsOnClick({
