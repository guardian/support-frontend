...
function EndSummary({
  ...
  return <span>
      {orderIsAGift ? <GiftSummary giftText={giftText} /> : <NonGiftSummary promotion={promotion} priceDescription={priceDescription} />}
    </span>;
}
...
function GiftSummary(props: GiftSummaryTypes) {
  return <ul css={styles.list}>
      <li>
        <Dot /><div css={styles.listMain}>{props.giftText.period}</div>
...
function NonGiftSummary(props: NonGiftSummaryTypes) {
  return <ul css={styles.list}>
      <li>
        <Dot /><div css={styles.listMain}>{props.promotion}</div>
