...
const content = <Provider store={store}>
    <Page header={<Header countryGroupId={countryGroupId} />} footer={<Footer termsConditionsLink="https://www.theguardian.com/info/2014/aug/06/guardian-observer-digital-subscriptions-terms-conditions" />}>
