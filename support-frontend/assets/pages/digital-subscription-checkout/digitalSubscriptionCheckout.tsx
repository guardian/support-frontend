...
const content = orderIsAGift ? <Provider store={store}>
      <Page header={<HeaderWrapper />} footer={<DigitalFooter country={countryId} productPrices={productPrices} orderIsAGift />}>
      ...
      <Page header={<HeaderWrapper />} footer={<DigitalFooter country={countryId} productPrices={productPrices} orderIsAGift={false} />}>
