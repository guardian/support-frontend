...
export const MustSignIn = (props: PropTypes) => {
  ...
  if (canContributeWithoutSigningIn(props.contributionType, props.isSignedIn, props.userTypeFromIdentityResponse) || !props.checkoutFormHasBeenSubmitted) {
    return null;
  }
  ...
  switch (props.userTypeFromIdentityResponse) {
    ...
    case 'current':
      return <a className={classNameWithModifiers('form__error', ['sign-in'])} href={signInUrl} onClick={onClick}>
