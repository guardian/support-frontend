...
import { type PaymentResult, type StripePaymentMethod, type StripePaymentRequestButtonMethod } from "helpers/paymentIntegrations/readerRevenueApis";
...
import { onThirdPartyPaymentAuthorised, paymentWaiting as setPaymentWaiting, setHandleStripe3DS, setPaymentRequestButtonPaymentMethod, setStripePaymentRequestButtonClicked, setStripePaymentRequestButtonError, setStripePaymentRequestObject, updateBillingCountry, updateBillingState, updateEmail, updateFirstName, updateLastName, updatePaymentMethod } from "pages/contributions-landing/contributionsLandingActions";
...
type PropTypes = {
  ...
  setStripePaymentRequestObject: (paymentRequest: Record<string, any>, stripeAccount: StripeAccount) => void;
...
const mapDispatchToProps = (dispatch: (...args: Array<any>) => any) => ({
  ...
  setStripePaymentRequestObject: (paymentRequest: Record<string, any>, stripeAccount: StripeAccount) => dispatch(setStripePaymentRequestObject(paymentRequest, stripeAccount)),
...
const PaymentRequestButton = (props: PropTypes) => {
  ...
  if (!props.stripePaymentRequestButtonData.paymentMethod || props.stripePaymentRequestButtonData.paymentMethod === 'none') {
    return null;
  }
  ...
  return <div className="stripe-payment-request-button__container" data-for-stripe-account={props.stripeAccount} data-for-contribution-type={props.contributionType}>
    ...
    }} className="stripe-payment-request-button__button" style={paymentButtonStyle} onClick={event => {
      onClick(event, props);
    }} />
