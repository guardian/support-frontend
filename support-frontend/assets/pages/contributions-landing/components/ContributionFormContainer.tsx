...
function withProps(props: PropTypes) {
  ...
  return <div className="gu-content__content gu-content__content-contributions gu-content__content--flex">
      {showPreviousGiving && lastOneOffContribution && <ContributionFormBlurb headerCopy={<PreviousGivingHeaderCopy userName={props.userName} />} bodyCopy={<PreviousGivingBodyCopy lastOneOffContribution={lastOneOffContribution} />} />}

      {!showPreviousGiving && <ContributionFormBlurb headerCopy={countryGroupDetails.headerCopy} bodyCopy={countryGroupDetails.contributeCopy} />}

      <div className="gu-content__form">
        {showSecureTransactionIndicator()}

        {campaignSettings && campaignSettings.tickerSettings ? <ContributionTicker {...campaignSettings.tickerSettings} onGoalReached={props.setTickerGoalReached} /> : null}
