...
function ContributionErrorMessage(props: PropTypes) {
  ...
  if (props.paymentError) {
    ...
    return <GeneralErrorMessage classModifiers={['invalid_form_mobile']} errorHeading="Form incomplete" errorReason="invalid_form_mobile" />;
  } else if (shouldsShowExistingContributorErrorMessage) {
    return <ExistingRecurringContributorErrorMessage contributionType={props.contributionType} checkoutFormHasBeenSubmitted={props.checkoutFormHasBeenSubmitted} isRecurringContributor={props.isRecurringContributor} />;
  }
