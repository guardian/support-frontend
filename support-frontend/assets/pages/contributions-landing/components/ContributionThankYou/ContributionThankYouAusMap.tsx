...
const ContributionThankYouAusMap = () => {
  ...
  const actionHeader = <ActionHeader title="Hear from supporters across Australia" />;
  const actionBody = <ActionBody>
      ...
      <div css={buttonContainer}>
        <LinkButton onClick={() => trackComponentClick(OPHAN_COMPONENT_ID_AUS_MAP)} href={AUS_MAP_URL} target="_blank" rel="noopener noreferrer" priority="primary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon>
          View the map
        </LinkButton>
      </div>
    </ActionBody>;
