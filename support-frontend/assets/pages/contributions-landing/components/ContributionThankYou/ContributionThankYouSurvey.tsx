...
const ContributionThankYouSurvey = () => {
  ...
  const actionHeader = <ActionHeader title={hasBeenCompleted ? 'Thank you for sharing your thoughts' : 'Send us your thoughts'} />;
  ...
  const actionBody = <ActionBody>
      {hasBeenCompleted ? <p>
          ...
          <div css={buttonContainer}>
            <LinkButton onClick={onClick} href={SURVEY_LINK} target="_blank" rel="noopener noreferrer" priority="primary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon>
              Provide feedback
            </LinkButton>
          </div>
        </>}
