...
const isLargeDonation = (amount: string, contributionType: ContributionType): boolean => {
...
const ContributionThankYou = ({
  ...
  useEffect(() => {
    trackUserData(paymentMethod, contributionType, user.isSignedIn, isKnownEmail, isLargeDonation(amount, contributionType));
  }, []);
  const signUpAction = {
  ...
  const socialShareAction = {
    component: <ContributionThankYouSocialShare email={email} createReferralCodes={campaignSettings && campaignSettings.createReferralCodes} campaignCode={campaignSettings && campaignSettings.campaignCode} />,
    shouldShow: true
  };
  const ausMapAction = {
  ...
  return <div css={container}>
      <div css={headerContainer}>
        <ContributionThankYouHeader name={name} showDirectDebitMessage={paymentMethod === DirectDebit} paymentMethod={paymentMethod} contributionType={contributionType} amount={amount} currency={currency} shouldShowLargeDonationMessage={isLargeDonation(amount, contributionType)} />
      </div>
