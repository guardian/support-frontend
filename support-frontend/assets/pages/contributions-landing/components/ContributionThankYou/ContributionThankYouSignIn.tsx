...
import { OPHAN_COMPONENT_ID_SIGN_IN, OPHAN_COMPONENT_ID_READ_MORE_SIGN_IN } from "./utils/ophan";
...
const ContributionThankYouSignIn = ({
  ...
  useEffect(() => {
    ...
    }).then(response => response.json()).then(data => setSignInUrl(data.signInLink));
  }, []);
  useEffect(() => {
  ...
  const actionBody = <ActionBody>
      ...
      <div css={buttonContainer}>
        <LinkButton onClick={onSignInClick} href={signInUrl} target="_blank" rel="noopener noreferrer" priority="primary" size="default" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon>
          Continue
        </LinkButton>
      </div>
    </ActionBody>;
