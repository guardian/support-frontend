...
const AustraliaMapLink = () => <section className="contribution-thank-you-block">
    ...
    <ThemeProvider theme={buttonBrandAlt}>
      <LinkButton target="_blank" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon href="https://support.theguardian.com/aus-map?INTCMP=thankyou-page-aus-map-cta" onClick={() => trackComponentClick('contribution-thankyou-aus-map')}>
        View the map
      </LinkButton>
    </ThemeProvider>
  </section>;
