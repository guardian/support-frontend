...
const mapStateToProps = (state: State) => ({
  ...
  productSetAbTestVariant: state.common.abParticipations.productSetTest === 'variant'
});
...
function ContributionForm(props: PropTypes) {
  ...
  return <form onSubmit={onSubmit(props)} className={classNameWithModifiers(baseClass, classModifiers)} noValidate>
      ...
      <TermsPrivacy countryGroupId={props.countryGroupId} contributionType={props.contributionType} campaignSettings={props.campaignSettings} currency={props.currency} amount={getAmount(props.selectedAmounts, props.otherAmounts, props.contributionType)} />
