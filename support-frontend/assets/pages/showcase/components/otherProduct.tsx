...
export default function OtherProduct(props: PropTypes) {
  return <div className={classNameWithModifiers('other-product', [props.modifierClass])}>
      <Heading size={3} className="product-title">{props.title}</Heading>
      <div>{props.description}</div>
      <AnchorButton icon={<ArrowRightStraight />} appearance="greyHollow" href={props.destination} onClick={() => {
