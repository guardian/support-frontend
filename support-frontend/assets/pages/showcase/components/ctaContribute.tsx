...
export default function CtaContribute() {
  return <Content appearance="highlight" modifierClasses={['contribute']}>
      <div className="wrapper">
        ...
        <div>
          ...
          <NarrowContent>
            <AnchorButton icon={<ArrowRightStraight />} appearance="secondary" href="/contribute" onClick={sendTrackingEventsOnClick({
