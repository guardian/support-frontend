...
export default function CtaSubscribe() {
  return <Content appearance="feature" modifierClasses={['subscribe']} image={<GridImage gridId="showcaseSubscribe" srcSizes={[1000, 500]} sizes="(max-width: 740px) 90vw, 600px" imgType="png" />}>
      ...
      <NarrowContent>
        <AnchorButton icon={<ArrowRightStraight />} href="/subscribe" onClick={sendTrackingEventsOnClick({
