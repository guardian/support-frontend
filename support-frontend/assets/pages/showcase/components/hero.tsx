...
export default function Hero(props: {
  ...
  return <div className="showcase-hero">
      <figure className="showcase-hero-wrapper">
        ...
        <div className="showcase-hero--left">
          <div className="showcase-hero__image showcase-hero__image--first">
            <Caption className="showcase-hero__caption--desktop" captionText={regionalContent[countrySelector].caption} />
            <div>
              <GridImage gridId={regionalContent[countrySelector].images.first} srcSizes={[1000, 500]} sizes="(max-width: 740px) 100vw, 400px" imgType="jpg" />
            </div>
          </div>
          <div className="showcase-hero__image showcase-hero__image--second">
            <GridImage gridId={regionalContent[countrySelector].images.second} srcSizes={[1000, 500]} sizes="(max-width: 740px) 100vw, 400px" imgType="jpg" />
          </div>
        </div>
        <div className="showcase-hero--right">
          <div className="showcase-hero__image showcase-hero__image--third">
            <GridImage gridId={regionalContent[countrySelector].images.third} srcSizes={[1000, 500]} sizes="(max-width: 740px) 100vw, 400px" imgType="jpg" />
          </div>
          <div className="showcase-hero__image showcase-hero__image--fourth">
            <GridImage gridId={regionalContent[countrySelector].images.fourth} srcSizes={[1000, 500]} sizes="(max-width: 740px) 100vw, 600px" imgType="jpg" />
          </div>
        </div>
        <Caption className="showcase-hero__caption--mobile" captionTitle={regionalContent[countrySelector].title} captionText={regionalContent[countrySelector].caption} />
      </figure>
    </div>;
}