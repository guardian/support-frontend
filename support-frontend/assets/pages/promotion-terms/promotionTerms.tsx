...
function getTermsConditionsLink({
  product
}: PromotionTerms) {
...
// ----- Render ----- //
const PromotionTermsPage = (props: State) => <Provider store={store}>
    <Page header={<Header countryGroupId={detect()} />} footer={<Footer faqsLink="https://www.theguardian.com/subscriber-direct/subscription-frequently-asked-questions" termsConditionsLink={getTermsConditionsLink(props.page.promotionTerms)} />}>
