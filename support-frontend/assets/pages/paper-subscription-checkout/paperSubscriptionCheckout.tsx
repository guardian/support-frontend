...
const reducer = (commonState: CommonState) => createWithDeliveryCheckoutReducer(commonState.internationalisation.countryId, Paper, Monthly, startDate, productOption, fulfilmentOption);
...
const content = <Provider store={store}>
    <Page header={<HeaderWrapper />} footer={<Footer faqsLink="https://www.theguardian.com/subscriber-direct/subscription-frequently-asked-questions" termsConditionsLink="https://www.theguardian.com/subscriber-direct/subscription-terms-and-conditions">
      ...
      <CheckoutStage checkoutForm={<CheckoutForm />} thankYouContentPending={<ThankYouContent isPending countryGroupId={countryGroupId} />} thankYouContent={<ThankYouContent isPending={false} countryGroupId={countryGroupId} />} subscriptionProduct="Paper" />
    </Page>
  </Provider>;
