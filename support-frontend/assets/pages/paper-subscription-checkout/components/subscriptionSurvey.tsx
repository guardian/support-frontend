  ...
  return surveyLink ? <Content>
      <section css={maxWidth}>
        ...
        <ThemeProvider theme={buttonReaderRevenue}>
          <LinkButton css={marginForButton} href={surveyLink} priority="tertiary" icon={<SvgArrowRightStraight />} iconSide="right" nudgeIcon aria-label="Link to subscription survey" target="_blank" rel="noopener noreferrer">
            Share your thoughts
          </LinkButton>
        </ThemeProvider>
      </section>
