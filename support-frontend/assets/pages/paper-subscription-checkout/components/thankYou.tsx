...
const whatNextText: Record<FulfilmentOptions, Array<string>> = {
  [HomeDelivery]: [`Look out for an email from us confirming your subscription.
          It has everything you need to know about how to manage it in the future.`, 'Your newspaper will be delivered to your door.'],
