...
import { AUDCountries, Canada, detect, EURCountries, GBPCountries, International, NZDCountries, UnitedStates } from "helpers/internationalisation/countryGroup";
...
const WeeklyLandingPage = ({
  ...
  const giftNonGiftLink = orderIsAGift ? routes.guardianWeeklySubscriptionLanding : routes.guardianWeeklySubscriptionLandingGift;
  ...
  return <Page id={pageQaId} header={<Header />} footer={<WeeklyFooter centred promoTermsLink={promoTermsLink} />}>
      <WeeklyHero orderIsAGift={orderIsAGift || false} countryGroupId={countryGroupId} promotionCopy={sanitisedPromoCopy} />
      <FullWidthContainer>
        <CentredContainer>
          <Block>
      ...
      <FullWidthContainer theme="dark" hasOverlap>
        <CentredContainer>
          <WeeklyProductPrices countryId={countryId} productPrices={productPrices} orderIsAGift={orderIsAGift || false} />
        </CentredContainer>
      </FullWidthContainer>
