...
import { detect, GBPCountries, type CountryGroupId } from "helpers/internationalisation/countryGroup";
...
const getRegionalCopyFor = (region: CountryGroupId) => region === GBPCountries ? <span>Find clarity with The Guardian&apos;s global magazine</span> : <span>Read The Guardian in print</span>;
