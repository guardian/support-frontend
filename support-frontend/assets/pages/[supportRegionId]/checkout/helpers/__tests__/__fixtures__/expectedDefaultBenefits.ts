...
> = {
	Contribution: {
		uk: ContributionBenefits,
		us: ContributionBenefitsUS,
		au: ContributionBenefitsAUD,
		eu: ContributionBenefits,
		int: ContributionBenefits,
		nz: ContributionBenefits,
		ca: ContributionBenefits,
	},
	SupporterPlus: {
		uk: SupporterPlusBenefits,
		us: SupporterPlusBenefitsUS,
		au: SupporterPlusBenefitsAUD,
		eu: SupporterPlusBenefits,
		int: SupporterPlusBenefits,
		nz: SupporterPlusBenefits,
		ca: SupporterPlusBenefits,
	},
	DigitalSubscription: {
		uk: DigitalSubscriptionBenefitsGBP,
		us: DigitalSubscriptionBenefitsUS,
		au: DigitalSubscriptionBenefitsAUD,
		eu: DigitalSubscriptionBenefits,
		int: DigitalSubscriptionBenefits,
		nz: DigitalSubscriptionBenefits,
		ca: DigitalSubscriptionBenefits,
	},
};
