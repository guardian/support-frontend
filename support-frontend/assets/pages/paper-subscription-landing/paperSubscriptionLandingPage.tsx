...
import { PaperLandingPropTypes } from "./paperSubscriptionLandingProps";
import { paperLandingProps } from "./paperSubscriptionLandingProps";
// ----- Collection or delivery ----- //
const reactElementId = 'paper-subscription-landing-page';
// ----- Redux Store ----- //
const paperSubsFooter = <Footer faqsLink="https://www.theguardian.com/subscriber-direct/subscription-frequently-asked-questions" termsConditionsLink="https://www.theguardian.com/subscriber-direct/subscription-terms-and-conditions" />;
// ----- Render ----- //
...
const PaperLandingPage = ({
  ...
  return <Page id={pageQaId} header={<Header countryGroupId={GBPCountries} />} footer={paperSubsFooter}>
