...
import { finalPrice, getProductPrice } from "helpers/productPrice/paperProductPrices";
...
const getPlans = (fulfilmentOption: PaperFulfilmentOptions, productPrices: ProductPrices) => ActivePaperProductTypes.map(productOption => {
  ...
  const nonDiscountedPrice = getProductPrice(productPrices, fulfilmentOption, productOption);
  return {
