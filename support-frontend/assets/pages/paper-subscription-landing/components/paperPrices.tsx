...
const copy = {
	HomeDelivery: {
		Everyday: (
			<>
				{' '}
				for <strong>Guardian</strong> and <strong>Observer</strong>, delivered
			</>
		),
		Sixday: (
			<>
				{' '}
				for <strong>Guardian</strong>, delivered
			</>
		),
		Weekend: (
			<>
		...
		Sunday: (
			<>
				{' '}
				for <strong>Observer</strong>, delivered
			</>
		),
	},
	Collection: {
		Everyday: (
			<>
				{' '}
				for <strong>Guardian</strong> and <strong>Observer</strong>
			</>
		),
		Sixday: (
			<>
				{' '}
				for <strong>Guardian</strong>
			</>
		),
		Weekend: (
			<>
