...
export const SubsCardFaqBlock = () => <FlexContainer cssOverrides={flexContainerOverride}>
    ...
    <GridImage gridId="printCampaignDigitalVoucher" srcSizes={[562, 500, 140]} sizes="(max-width: 740px) 100vw, 500px" imgType="png" />
  </FlexContainer>;