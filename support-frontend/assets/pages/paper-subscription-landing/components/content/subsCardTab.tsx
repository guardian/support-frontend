...
// ----- Content ----- //
const LinkToImovo = ({ trackingId }: { trackingId: string }) => {
	...
	return (
		<a
			onClick={trackClick}
			href="https://imovo.org/guardianstorefinder"
			target="_blank"
				...
				<Accordion>
					...
					>
						<>
							...
							<p>
								<LinkToImovo trackingId={collectonAccordionTrackingId} />
							</p>
						</>
					</TabAccordionRow>
					<TabAccordionRow
					...
					>
						<>
							...
							<p>
								<LinkToImovo trackingId={deliveryAccordionTrackingId} />
							</p>
						</>
					</TabAccordionRow>
				</Accordion>
