...
const DiscountCalloutMaybe = () => {
  ...
  const [discount, duration] = [getDiscount('Paper', 'GBPCountries'), getDuration('Paper', 'GBPCountries')];
...
function Prices({
  ...
  return <section css={pricesSection} id="subscribe">
      ...
      <div css={pricesInfo}>
        {activeTab === Collection ? <LinkTo tab={HomeDelivery} setTabAction={setTabAction}>Switch to Delivery</LinkTo> : <LinkTo tab={Collection} setTabAction={setTabAction}>
