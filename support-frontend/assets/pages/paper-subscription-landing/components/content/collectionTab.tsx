...
`;
// ----- Content ----- //
export const ContentVoucherFaqBlock = () => <Content border={paperHasDeliveryEnabled()} image={<GridImage gridId="paperVoucherFeature" srcSizes={[750, 500, 140]} sizes="(max-width: 740px) 100vw, 400px" imgType="png" />}>
    <Text>
