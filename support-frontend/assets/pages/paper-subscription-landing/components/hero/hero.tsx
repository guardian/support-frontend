...
function PaperHero({
  ...
  return <PageTitle title="Newspaper subscription" theme="paper">
      <CentredContainer>
        <Hero image={<GridImage gridId="printCampaignHeroHD" srcSizes={[1000, 500, 140]} sizes="(max-width: 740px) 100%,
            (max-width: 1067px) 150%,
            500px" imgType="png" altText="Newspapers" />} roundelText={roundelText} roundelNudgeDirection="down" hideRoundelBelow="mobileMedium">
