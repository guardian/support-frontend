...
import { DigitalLandingPropTypes } from "./digitalSubscriptionLandingProps";
...
function DigitalLandingPage({
  ...
  const heroPriceList = getHeroCtaProps(productPrices, currencyId, countryGroupId);
  ...
  const footer = <div className="footer-container">
      <div className="footer-alignment">
        <DigitalFooter country={countryGroupId} orderIsAGift={isGift} productPrices={productPrices} centred />
      </div>
    </div>;
  return <Page header={<CountrySwitcherHeader />} footer={footer}>
      {orderIsAGift ? <HeroWithImage orderIsAGift={isGift} countryGroupId={countryGroupId} promotionCopy={sanitisedPromoCopy} /> : <HeroWithPriceCards promotionCopy={sanitisedPromoCopy} countryGroupId={countryGroupId} priceList={heroPriceList} />}
        ...
        <CentredContainer>
          <Block cssOverrides={[productBlockContainer, showEventsComponent ? productBlockContainerWithEvents : '']}>
            <div ref={setElementToObserve}>
              {countryGroupId === AUDCountries ? <ProductBlockAus countryGroupId={countryGroupId} /> : <ProductBlock countryGroupId={countryGroupId} />}
            </div>
          </Block>
        </CentredContainer>
      </FullWidthContainer>
      <FullWidthContainer theme="dark" hasOverlap>
        <CentredContainer>
          <Prices countryGroupId={countryGroupId} currencyId={currencyId} productPrices={productPrices} orderIsAGift={isGift} />
        </CentredContainer>
      </FullWidthContainer>
