...
import { AUDCountries, Canada, type CountryGroupId, detect, EURCountries, GBPCountries, International, NZDCountries, UnitedStates } from "helpers/internationalisation/countryGroup";
...
import digitalSubscriptionLandingReducer, { type State } from "./digitalSubscriptionLandingReducer";
...
const heroPriceList = getHeroCtaProps(productPrices, internationalisation.currencyId, internationalisation.countryGroupId);
...
function LandingPage() {
  ...
  return <Page header={<CountrySwitcherHeader />} footer={footer}>
      <DigitalHero orderIsAGift={orderIsAGift} countryGroupId={countryGroupId} promotionCopy={sanitisedPromoCopy} showPriceCards={showPriceCardsInHero} priceList={heroPriceList} />
      <FullWidthContainer>
        <CentredContainer>
