...
function HeroWithImage({
  ...
  return <PageTitle title="Give the digital subscription" theme="digital">
      <CentredContainer>
        <Hero image={<GridImage gridId={countryGroupId === AUDCountries ? 'editionsPackshotAus' : 'editionsPackshot'} srcSizes={[1000, 500, 140]} sizes="(max-width: 480px) 200px,
                (max-width: 740px) 100%,
