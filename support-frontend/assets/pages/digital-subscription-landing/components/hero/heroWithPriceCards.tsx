...
import { heroCopy, heroTitle, paragraphs, yellowHeading, circleTextGeneric, roundelOverrides, embeddedRoundel } from "./heroWithPriceCardsStyles";
type PropTypes = {
...
function HeroWithPriceCards({
  ...
  return <PageTitle title="Digital subscription" theme="digital">
      <CentredContainer>
        <Hero image={<HeroPriceCards priceList={priceList} roundel={<HeroRoundel cssOverrides={embeddedRoundel} theme="digital">
                  {roundelText}
                </HeroRoundel>} />} roundelElement={<HeroRoundel cssOverrides={roundelOverrides} theme="digital">
              {roundelText}
            </HeroRoundel>}>
