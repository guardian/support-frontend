...
function FeedbackWidget({
  ...
  return <aside css={[wrapper, showWidget ? '' : hideWidget]}>
      <fieldset role="group">
        <div css={header}>
          <p css={widgetTitle}>
          ...
          <span>
            <ThemeProvider theme={buttonBrand}>
              <Button priority="subdued" size="small" hideLabel aria-label="Is this page helpful? Yes, this page has the information I am looking for" icon={<SvgThumbsUp />} cssOverrides={[positiveButtonCss, buttonStyles]} onClick={() => {
            ...
            <ThemeProvider theme={buttonBrand}>
              <Button priority="subdued" size="small" hideLabel aria-label="Is this page helpful? No, this page does not have the information I am looking for" icon={<SvgThumbsDown />} cssOverrides={[negativeButtonCss, buttonStyles]} onClick={() => {
              sendTrackingEventsOnClick({
        ...
        {clicked.open && <div css={feedbackLink} aria-hidden={!clicked.negative}>
            ...
            <LinkButton size="small" id="feedbackLink" aria-label="Click here to fill in a short survey about the information on this page" href="https://www.surveymonkey.co.uk/r/63XM7CX" target="_blank" rel="noopener noreferrer" onClick={() => setShowWidget(false)}>
