...
import { PaymentSelectionPropTypes } from "./paymentSelection/helpers/paymentSelection";
...
function Prices({
  ...
  return <section css={pricesSection} id="subscribe">
      ...
      <FlexContainer cssOverrides={priceBoxes}>
        <PaymentSelection countryGroupId={countryGroupId} currencyId={currencyId} productPrices={productPrices} orderIsAGift={orderIsAGift} />
      </FlexContainer>
    </section>;
}
