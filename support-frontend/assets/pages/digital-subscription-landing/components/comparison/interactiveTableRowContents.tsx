	...
	return {
		journalism: {
			...
			columns: [
				{
					content: (
						<>
							...
							<span>
								Access to the Guardian&apos;s quality, open journalism
							</span>
						</>
					),
					isPrimary: true,
			...
			details: (
				<div css={detailsCellImageFirst}>
					<p>
						Independent, honest reporting should be available for everyone
						without a paywall. With a subscription, you can help to protect the
						Guardian’s editorial independence and support our model for open
						access journalism, so millions more can benefit.
					</p>
		...
		editionsApp: {
			...
			columns: [
				{
					content: (
						<>
							...
							<span>
								<strong>The Editions app:</strong> newspapers reimagined
			...
			details: (
				<div css={detailsCellImageFirst}>
					<p>
						Experience digital news differently. Available exclusively to
						subscribers,{' '}
						{isAustralia
							? 'Australia Weekend brings you the stories you need to understand the week'
							: 'the UK Daily brings you the stories you need for the day'}
						. With a beginning and an end, it’s an immersive, considered
						alternative to your never-ending news feed.{' '}
						{isAustralia ? 'The UK Daily' : 'Australia Weekend'} and one-off
						special Editions are also available for you to enjoy.
					</p>
					<div
						css={[
							detailsCellImageFirstContainer,
							detailsCellImageContainerFullHeight,
						]}
					>
						<GridPicture
							sources={[
		...
		premiumApp: {
			...
			columns: [
				{
					content: (
						<>
							...
							<span>
								<strong>The Guardian app</strong> with premium features
							</span>
						</>
					),
					isPrimary: true,
			...
			details: (
				<div css={detailsCellImageSecond}>
					<p>
						<strong>Explore interactive features</strong> that help you stay on
						top of <strong>breaking news</strong>, or keep curious by following
						topics that matter to you.
					</p>
					<div
						css={[
							detailsCellImageSecondContainer,
							detailsCellImageContainerBottomSpacing,
						]}
					>
						<GridPicture
							sources={[
				...
				<div css={detailsCellOfflineReading}>
					<div css={appFeatureImageContainer}>
						...
						<AppFeatureWithIcon appName="Editions">
							<p>
								Download any edition from the last 30 days to read anytime,
								anywhere you are.
							</p>
						</AppFeatureWithIcon>
					</div>
					<div css={appFeatureImageContainer}>
						<AppFeatureWithIcon appName="Guardian">
							<p>
								<strong>Enhanced offline reading.</strong> Download the news
				...
				<div css={detailsColumnCrosswords}>
					<div>
						<AppFeatureWithIcon appName="Guardian" heading="Daily crosswords">
							<p>
								Play daily crosswords wherever you are in{' '}
								<strong>the Guardian app.</strong>
							</p>
						</AppFeatureWithIcon>
					</div>
