...
const Padlock = () => <div aria-label="Not included" css={[indicators, padlock, greyBackground]}>
    <SvgPadlock />
  </div>;
...
const Checkmark = (props: {
  ...
  const checkMarkStyles = props.borderLeft ? [indicators, checkmark, yellowBackground, props.borderLeft] : [indicators, checkmark, yellowBackground];
  return <div aria-label="Included" css={checkMarkStyles}>
      <SvgCheckmark />
    </div>;
};
