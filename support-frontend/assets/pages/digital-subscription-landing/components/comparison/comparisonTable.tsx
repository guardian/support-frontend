...
const ComparisonTableRow = ({
  ...
  paid,
  cssOverrides
}: TableRow) => <tr css={[rowStyle, cssOverrides]}>
...
const ComparisonTable = () => <section css={container}>
    ...
    <table css={table}>
      ...
      <tbody css={tableContainer}>
        {tableContent.map(row => <ComparisonTableRow cssOverrides={row.cssOverrides} icon={row.icon} description={row.description} free={row.free} paid={row.paid} />)}
      </tbody>
      <tfoot>
        <tr css={[rowStyle]}>
