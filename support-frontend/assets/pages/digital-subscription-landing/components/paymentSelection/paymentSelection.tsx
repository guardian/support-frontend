...
import { PaymentSelectionPropTypes } from "./helpers/paymentSelection";
...
<div css={paymentSelection}>
    ...
    return 0;
  }).map(product => <ProductOption cssOverrides={product.label ? productOverrideWithLabel : productOverride} title={product.title} price={product.price} offerCopy={product.offerCopy} priceCopy={product.priceCopy} buttonCopy={product.buttonCopy} href={product.href} onClick={product.onClick} onView={product.onView} label={product.label} />)}
    </div>;
