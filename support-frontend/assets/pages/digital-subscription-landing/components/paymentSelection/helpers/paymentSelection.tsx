...
import type { ProductPrices, BillingPeriods, ProductPrice } from "helpers/productPrice/productPrices";
...
const getHeroCtaProps = (productPrices: ProductPrices, currencyId: IsoCurrency, countryGroupId: CountryGroupId, isUsingGuestCheckout: boolean, showPayPalButton: boolean): ProductSmall[] => {
