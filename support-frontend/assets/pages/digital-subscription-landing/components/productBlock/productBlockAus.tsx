...
const appImageAus = <GridPicture sources={[{
  ...
  sizes: '(min-width: 1300px) 750px, (min-width: 1140px) 700px, (min-width: 980px) 600px, (min-width: 740px) 60vw',
  media: '(min-width: 740px)'
}]} fallback="liveAppDesktop" fallbackSize={500} altText="" fallbackImgType="jpg" />;
  ...
  render() {
    ...
    return <div className="hope-is-power__products">
        <section className="product-block__container hope-is-power--centered">
          ...
          <ProductCard title="Australia Weekend in The Guardian Editions app" subtitle={<span className="product-block__item__subtitle--short-first">
                Everything you need to make sense of the week, in one simple, elegant app
              </span>} image={weekendImage} first secondImage={false} />
          ...
          <Plus />
          <ProductCard title="Premium access to The Guardian Live app" subtitle={<span className="product-block__item__subtitle--short-second">Live news, as it happens</span>} image={appImageAus} first={false} secondImage />
