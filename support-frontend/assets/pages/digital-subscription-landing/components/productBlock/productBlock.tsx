...
const dailyImage = <GridPicture sources={[{
...
}]} fallback="editionsRowDesktop" fallbackSize={500} altText="" fallbackImgType="png" />;
const weekendImage = <GridPicture sources={[{
  ...
  sizes: '(min-width: 1300px) 750px, (min-width: 1140px) 700px, (min-width: 980px) 600px, (min-width: 740px) 60vw',
  media: '(min-width: 740px)'
}]} fallback="weekendPackshotDesktop" fallbackSize={500} altText="" fallbackImgType="png" />;
const appImage = <GridPicture sources={[{
  ...
  sizes: '(min-width: 1300px) 750px, (min-width: 1140px) 700px, (min-width: 980px) 600px, (min-width: 740px) 60vw',
  media: '(min-width: 740px)'
}]} fallback="liveAppDesktop" fallbackSize={500} altText="" fallbackImgType="png" />;
...
const DailyProductBlockSection = ({
  first,
  second
}: ProductSectionPropTypes) => <ProductBlockSection product="Daily" render={showDropDown => <>
        <ProductCard title="UK Daily in the Guardian Editions app" subtitle="Each day&apos;s edition, in one simple, elegant app" image={dailyImage} first={first} second={second} />
      ...
      explainer: 'Each edition available to read by 6am (GMT), 7 days a week'
    }, {
      boldText: 'Easy to navigate',
      explainer: 'Read the complete edition, or swipe to the sections you care about'
    }]} />
          <ListHeading items={[{
      boldText: 'Multiple devices',
      explainer: 'Beautifully designed for your mobile or tablet on iOS and Android'
    }, {
      boldText: 'Read offline',
      explainer: 'Download and read whenever it suits you'
    }, {
      boldText: 'Ad-free',
      explainer: 'Enjoy our journalism uninterrupted, without adverts'
    }, {
      boldText: 'Enjoy our other editions',
      explainer: 'Australia Weekend and other special editions are all included in the Guardian Editions app as part of your subscription'
    }]} />
        </Dropdown>
      </>} />;
...
const DailyProductBlockSectionAus = ({
  ...
  second
        ...
        <ProductCard title="Australia Weekend in the Guardian Editions app" subtitle="Everything you need to make sense of the week, in one simple, elegant app" image={weekendImage} first={first} second={second} secondImage={false} />
        <Dropdown showDropDown={showDropDown} product="Daily">
          <ListHeading items={[{
      boldText: 'A new way to read',
...
const PremiumAppProductBlockSection = ({
  first,
  second
}: ProductSectionPropTypes) => <ProductBlockSection product="App" render={showDropDown => <>
          <ProductCard title="Premium access to the Guardian Live app" subtitle="Live news, as it happens" image={appImage} first={first} second={second} />
          <Dropdown showDropDown={showDropDown} product="App">
            <ListHeading items={[{
      boldText: 'Live',
      explainer: 'Follow a live feed of breaking news and sport, as it happens'
    }, {
      boldText: 'Discover',
      explainer: 'Explore stories you might have missed, tailored to you'
    }, {
...
function ProductBlock({
  ...
  return <div className="hope-is-power__products">
