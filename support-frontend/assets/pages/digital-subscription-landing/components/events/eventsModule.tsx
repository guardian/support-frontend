    ...
    <section css={container}>
      <div css={contentContainer}>
        ...
        <div css={eventCardContainer}>
          <EventCard eventType="Featured event" eventImage={jessPhillips} eventDate="21 July 2021" eventTime="8-9pm BST" eventColour={news[400]} eventSectionText="Politics" eventDescription="Everything you really need to know about politics, with Jess Phillips MP" />
          <EventCard eventType="Featured masterclass" eventImage={robbieAndersonImage} eventDate="22 July 2021" eventTime="6.30-8pm BST" eventColour={sport[400]} eventSectionText="Sport" eventDescription="How to apply sports psychology to your life with Dr Robbie Anderson" />
        </div>
