...
const FeaturedEventCardUK = <EventCard eventType="Featured event" eventImage={keirStarmerImage} eventDate="20 Sept 2021" eventColour={news[400]} eventSectionText="Politics" eventDescription="Guardian Newsroom: Are the Labour Party electable?" />;
const FeaturedEventCardUS = <EventCard eventType="Featured event" eventImage={woleSoyinkaImage} eventDate="28 Sept 2021" eventColour={culture[400]} eventSectionText="Culture" eventDescription="Wole Soyinka in conversation" />;
    ...
    <section css={container}>
      <div css={contentContainer}>
        ...
        <div css={eventCardContainer}>
          {featuredEvent}
          <EventCard eventType="Featured masterclass" eventImage={felicityCloakeImage} eventDate="22 Sept 2021" eventColour={lifestyle[400]} eventSectionText="Lifestyle" eventDescription="How to write about food with Felicity Cloake" />
        </div>
