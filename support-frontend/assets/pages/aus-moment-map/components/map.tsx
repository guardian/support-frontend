...
const TerritorySvgContainer = (props: TerritorySvgContainerProps) => {
  ...
  return <g className={`territory ${props.isSelected ? 'territory-selected' : ''}`} onClick={windowWidthIsGreaterThan('desktop') ? props.onClick : null}>
      {props.children}
    </g>;
};
...
export const Map = React.forwardRef((props: MapProps, ref: React.Ref<typeof Map>) => <div className="map" ref={ref}>
