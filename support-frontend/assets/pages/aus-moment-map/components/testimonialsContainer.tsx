...
const TestimonialCtaPrimary = () => <div className="testimonial-cta testimonial-cta-primary">
    ...
    <ThemeProvider theme={buttonDefault}>
      <LinkButton className="testimonial-cta-primary-link-button" priority="primary" size="small" href="https://guardiannewsampampmedia.formstack.com/forms/australia_2021" target="_blank" rel="noopener noreferrer">
        Add your message
      </LinkButton>
    </ThemeProvider>
  </div>;
...
const TestimonialCtaSecondary = () => <div className="testimonial-cta testimonial-cta-secondary">
    ...
    <LinkButton className="testimonial-cta-secondary-link-button" priority="primary" size="small" href={contributeUrl('Aus_Moment_2021_map_inline')} target="_blank" rel="noopener noreferrer">Support the Guardian
    </LinkButton>
  </div>;
