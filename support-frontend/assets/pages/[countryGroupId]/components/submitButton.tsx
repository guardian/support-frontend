		...
		case 'PayPalCompletePayments':
			return (
				<>
					...
					<div>
						PayPalCompletePayments paypalClientId:{paypalClientId}{' '}
						payPalPaymentToken?.token:{payPalPaymentToken?.token}{' '}
						payPalPaymentToken?.email:{payPalPaymentToken?.email} isTestUser:
						{isTestUser}
					</div>
