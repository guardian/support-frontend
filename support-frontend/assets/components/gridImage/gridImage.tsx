...
export default function GridImage(props: PropTypes): Node {
  ...
  return <img className={classNameWithModifiers('component-grid-image', props.classModifiers || [])} sizes={props.sizes} srcSet={srcSet} src={fallbackSrc} alt={props.altText} />;
} // ----- Default Props ----- //
