...
import { type GridImage, type GridSlot, type Source as GridSource } from "components/gridPicture/gridPicture";
...
export type ImagesByCountry = Record<CountryGroupId, GridImages>;
type PropTypes = {
...
function ProductHero(props: PropTypes) {
  ...
  return <div className="component-product-hero">
      <LeftMarginSection>
        <GridPicture sources={sources} fallback={gridImages.fallback} fallbackSize={500} altText={props.altText} fallbackImgType={props.fallbackImgType} />
      </LeftMarginSection>
    </div>;
} // ----- Exports ----- //
