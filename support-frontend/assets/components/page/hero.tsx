...
import { RoundelTheme } from "./heroRoundel";
import HeroRoundel from "./heroRoundel";
import { hero, heroRoundelContainer, heroImage, roundelNudgeDown, roundelNudgeUp, roundelHidingPoints } from "./heroStyles";
...
function Hero({
  ...
  return <div css={[hero, cssOverrides]}>
      ...
      {!roundelText && roundelElement && <div css={[heroRoundelContainer, hideRoundel]}>
          {roundelElement}
        </div>}
      <div>
        {children}
