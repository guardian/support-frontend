			...
			<Stack space={5} cssOverrides={completedStack}>
				<ContentBox removePadding>
					...
					<Stack space={5} cssOverrides={contentPadding}>
						<div css={separator} />
						<Stack space={2}>
							<h1 css={headings}>This invitation is no longer available</h1>
							<p css={descriptions}>
								This invitation has expired and can no longer be used to access
								this subscription. If you&apos;d still like to join, please ask
