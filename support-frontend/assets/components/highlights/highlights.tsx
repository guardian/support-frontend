...
export default function Highlights(props: PropTypes) {
  ...
  return <Heading size={props.headingSize} className={classNameWithModifiers('component-highlights', props.modifierClasses)}>
      {props.highlights.map(highlight => <span className="component-highlights__line">
