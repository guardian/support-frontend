...
const List = ({
  items
}: ListPropTypes) => <ul className="product-block__list-item__ul--simple">
    {items.map(item => <li className="product-block__list-item__li--simple">
...
const ListHeading = ({
  items
}: ListPropTypes) => <ul className="product-block__list-item__ul">
    {items.map(item => <li className="product-block__list-item__li">
