...
import { fromCountryGroupId, currencies } from "helpers/internationalisation/currency";
...
function TermsPrivacy(props: PropTypes) {
  ...
  const shouldShowPhilanthropicAsk = isUSContributor && isNotOneOffContribution && sourceIsNotAppleNews && sourceIsNotGoogleAMP;
  return <>
