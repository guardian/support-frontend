...
const DigitalPackshot = (props: PropTypes) => <div className="subscriptions-int-daily-packshot">
    <GridPicture sources={[{
  ...
  }]} fallback="editionsPackshot" fallbackSize={1000} altText="" fallbackImgType="png" />
  </div>;
