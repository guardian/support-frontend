 ...
 *  */
const GuardianWeeklyPackShot = () => <div className="subscriptions__guardian-weekly-packshot">
    <GridImage gridId="subscriptionGuardianWeeklyPackShot" srcSizes={[500, 140]} sizes="(max-width: 739px) 140px,
