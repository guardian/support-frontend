...
function GiftOrPersonal({
  href,
  product,
  orderIsAGift
}: PropTypes) {
  return <section css={giftOrPersonal}>
      ...
      <LinkButton icon={<SvgArrowRightStraight />} iconSide="right" priority="tertiary" nudgeIcon href={href} onClick={() => {
