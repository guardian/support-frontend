...
function ProductOption(props: Product) {
  ...
  * */
  ...
  return <div ref={setElementToObserve} css={[productOption, props.cssOverrides]}>
      <div>
      ...
      <div>
        ...
        <ThemeProvider theme={buttonReaderRevenue}>
          <LinkButton href={props.href} onClick={props.onClick} aria-label={`${props.title}- ${props.buttonCopy}`}>
            {props.buttonCopy}
          </LinkButton>
        </ThemeProvider>
      </div>
