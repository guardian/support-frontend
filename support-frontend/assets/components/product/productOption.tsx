...
function ProductOption(props: Product) {
  ...
  * */
  ...
  `;
  return <div ref={setElementToObserve} css={[productOption, props.cssOverrides, productOptionMargin, productOptionButtonHeight]}>
      ...
      <div css={buttonDiv}>
        <ThemeProvider theme={buttonReaderRevenue}>
          <LinkButton css={button} href={props.href} onClick={props.onClick} aria-label={`${props.title}- ${props.buttonCopy}`}>
            {props.buttonCopy}
          </LinkButton>
        </ThemeProvider>
        {props.showPayPalButton && props.billingPeriod && <PayPalOneClickCheckoutButton billingPeriod={props.billingPeriod} trackingId="one-click-checkout-price-card" product={DigitalPack} />}
      </div>
    </div>;
}
