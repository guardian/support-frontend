...
import { Appearance } from "components/content/content";
...
function Footer({
  ...
  return <footer className="component-footer" role="contentinfo">
      {(disclaimer || privacyPolicy || Children.count(children) > 0) && <Content appearance={appearance}>
          <div className="component-footer__content ">
            <Rows>
              {privacyPolicy && <div className="component-footer__privacy-policy-text">
