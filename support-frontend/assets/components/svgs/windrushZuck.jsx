...
export default function WindrushZuck() {
  const windrushUrl = gridUrl('windrush', 370, 'png');
  const zuckUrl = gridUrl('zuck', 374, 'png');
  return (
    <svg className="svg-windrush-zuck" xmlns="http://www.w3.org/2000/svg" width="576" height="220" viewBox="0 0 576 220">
      ...
      <image href={windrushUrl} x="217" y="12" height="119" width="119" />
    </svg>
  );
}
