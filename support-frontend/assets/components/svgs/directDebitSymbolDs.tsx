...
export default function SvgDirectDebitSymbolDs() {
	return (
		<svg
			width="30"
			height="20"
			...
			className="svg-direct-debit-symbol"
			preserveAspectRatio="xMinYMid"
			aria-hidden="true"
			focusable="false"
			title="Direct Debit symbol"
		>
			<path
			...
			/>
			<path
				d="M15.5237 16.0714C13.5047 15.9238 10.9094 14.5761 10.9094 12.2619C10.9094 9.94757 13.1237 8.29995 15.5285 8.20947V16.0714"
				fill="#052962"
			/>
		</svg>
	);
