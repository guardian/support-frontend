...
import { type Action, closeDirectDebitPopUp, resetDirectDebitFormError } from "components/directDebit/directDebitActions";
...
const DirectDebitPopUpForm = (props: PropTypes) => {
  ...
  if (props.isPopUpOpen) {
    content = <div className="component-direct-debit-pop-up-form">
        <div className="component-direct-debit-pop-up-form__content">
          ...
          <button id="qa-pay-with-direct-debit-close-pop-up" className="component-direct-debit-pop-up-form__close-button focus-target" onClick={props.closeDirectDebitPopUp}>
            <span>
              <SvgCross />
            </span>
          </button>
