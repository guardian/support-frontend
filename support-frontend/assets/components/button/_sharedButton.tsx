...
const SharedButton = ({
  ...
  const className = classNameWithModifiers('component-button', [appearance, `hasicon-${iconSide}`, ...modifierClasses]);
  const contents = [<span className="component-button__content">{children}</span>, icon];
