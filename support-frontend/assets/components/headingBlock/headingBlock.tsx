...
function HeadingBlock(props: PropTypes) {
  ...
  return <div className={`component-heading-block${giftOrder}`}>
      <div className="component-heading-block__content">
        {props.overheading ? [<h1 className={`component-heading-block__overheading${overheadingClass}`}>{props.overheading}</h1>, <div className="component-heading-block__heading">
              <h2 className="component-heading-block__fontSize">{props.children}</h2>
            </div>] : <div className="component-heading-block__heading">
