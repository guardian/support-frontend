...
const SubscriptionsProductDescription = ({
  ...
  buttons
    ...
    <div className={isFeature ? 'subscriptions__button-container--feature' : 'subscriptions__button-container'}>
      {buttons.map((button, index) => <AnchorButton href={button.link} onClick={button.analyticsTracking} appearance={getButtonAppearance(isFeature, index, button.hierarchy)} modifierClasses={['subscriptions__product-button']}>
