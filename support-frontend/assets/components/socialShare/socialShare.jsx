...
const socialMedia: {
  ...
  facebook: {
    link: referralCodeQueryParameter =>
      `https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fsupport.theguardian.com%2Fcontribute?acquisitionData=%7B%22source%22%3A%22SOCIAL%22%2C%22campaignCode%22%3A%22component-social-facebook%22%2C%22componentId%22%3A%22component-social-facebook%22%7D&INTCMP=component-social-facebook${referralCodeQueryParameter ? `&${referralCodeQueryParameter}` : ''}`,
    svg: <SvgFacebook />,
  ...
  linkedin: {
    link: referralCodeQueryParameter =>
      `http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fsupport.theguardian.com%2Fcontribute${referralCodeQueryParameter ? `&${referralCodeQueryParameter}` : ''}`,
    svg: <SvgLinkedin />,
