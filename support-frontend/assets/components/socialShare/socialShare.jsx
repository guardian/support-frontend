...
const socialMedia: {
  ...
  linkedin: {
    link: referralCodeQueryParameter =>
      `http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fsupport.theguardian.com%2Fcontribute%3FacquisitionData%3Dthankyou_linkedin_${referralCodeQueryParameter || ''}`,
    svg: <SvgLinkedin />,
...
function SocialShare(props: PropTypes) {
  ...
  const ausMomentReferralCode = props.referralCode
