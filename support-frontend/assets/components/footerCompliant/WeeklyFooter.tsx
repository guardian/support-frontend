	...
	return (
		...
		>
			...
			<p>
				...
				(&ldquo;GNM&rdquo;) reserves the right to withdraw this promotion at any
				time. See{' '}
				<a target="_blank" rel="noopener noreferrer" href={promoTermsLink}>
					annual promotion terms and conditions
				</a>
				.
			</p>
		</Footer>
