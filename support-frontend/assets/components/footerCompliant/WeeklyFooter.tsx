...
export default function WeeklyFooter({
  ...
  return <Footer centred={centred} faqsLink="https://www.theguardian.com/help/2012/jan/19/guardian-weekly-faqs" termsConditionsLink="https://www.theguardian.com/info/2014/jul/10/guardian-weekly-print-subscription-services-terms-conditions">
