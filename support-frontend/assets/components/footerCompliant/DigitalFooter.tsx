...
const getPromoUrl = (productPrices: ProductPrices, country: IsoCountry, billingPeriod: BillingPeriod): Option<string> => {
  const promotion = getPromotion(productPrices, country, billingPeriod, NoFulfilmentOptions, NoProductOptions);
...
function DigitalFooter({
  ...
  const faqsLink = orderIsAGift ? 'https://www.theguardian.com/help/2020/nov/23/guardian-gift-digital-subscription-faqs' : 'https://www.theguardian.com/subscriber-direct/subscription-frequently-asked-questions';
  const termsConditionsLink = orderIsAGift ? 'https://www.theguardian.com/help/2020/nov/24/gift-digital-subscriptions-terms-and-conditions' : 'https://www.theguardian.com/info/2014/aug/06/guardian-observer-digital-subscriptions-terms-conditions';
  return <Footer faqsLink={faqsLink} termsConditionsLink={termsConditionsLink}>
      ...
      <p>Offer subject to availability. Guardian News and Media Ltd
        ...
        {orderIsAGift ? <GiftLinks productPrices={productPrices} country={country} /> : <RegularLinks productPrices={productPrices} country={country} />}.
      </p>
    </Footer>;
}
