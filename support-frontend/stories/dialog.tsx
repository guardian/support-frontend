...
// Teeny helpers
const GreyButton = props => <Button icon={null} appearance="greyHollow" {...props} />;

const OpenButton = props => <GreyButton aria-haspopup="dialog" {...props}>Open it up
  </GreyButton>;
...
stories.add('Styled dialog', () => <div style={{
  maxWidth: '30em'
}}>
...
stories.add('Unstyled dialog', () => <div style={{
  maxWidth: '30em'
}}>
    <Text title="This is an unstyled dialog example">
      ...
      bounds: {
        ...
        }} open={state.open} blocking={false} // this lets you click outside to close
        styled={false}>
