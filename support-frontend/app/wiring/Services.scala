...
import services.pricing.{DefaultPromotionsService, PriceSummaryServiceProvider}
...
trait Services {
  ...
  lazy val defaultPromotionsService = new DefaultPromotionsService(s3Client, appConfig.stage, actorSystem)
