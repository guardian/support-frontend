...
describe('hasDiscountOrPromotion', () => {
  it('should return a boolean depending on whether there are or are not promotions', () => {
    ...
    expect(hasDiscountOrPromotion(productPriceMonthlyWithDiscount))
      .toBe(true);

    expect(hasDiscountOrPromotion(productPriceMonthly))
      .toBe(false);

    expect(hasDiscountOrPromotion(productPriceAnnualWithDiscount))
      .toBe(true);

    expect(hasDiscountOrPromotion(productPriceAnnual))
      .toBe(false);
