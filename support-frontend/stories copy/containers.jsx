...
stories.add('Full-width container', () => {
  ...
  return (
    <FullWidthContainer theme={theme}>
      <CentredContainer>
        <div style={{
            backgroundColor: 'white', color: 'black', padding: '12px', height: '200px', width: '100%',
          }}
        >
...
stories.add('Flex container', () => (
  <div style={{ width: '100%' }}>
    <CentredContainer>
      <FlexContainer>
        <p style={{
          border: '1px solid black', padding: '12px', height: '200px', minWidth: '50%',
        }}
