...
class PromotionsConfigSpec extends AsyncFlatSpec with Matchers {
  "PromotionsTablesConfigProvider" should "load successfully" in {
    ...
    devConfig.tables.promotions shouldBe "support-admin-console-promos-CODE"
    ...
    codeConfig.tables.promotions shouldBe "support-admin-console-promos-CODE"
    ...
    prodConfig.tables.promotions shouldBe "support-admin-console-promos-PROD"
