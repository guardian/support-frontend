...
libraryDependencies ++= Seq(
  ...
  "org.scalatestplus" %% "scalatestplus-mockito" % "1.0.0-SNAP5" % "it,test",
  "org.scalatestplus" %% "scalatestplus-selenium" % "1.0.0-SNAP5" % "it,test",
  ...
  "com.gocardless" % "gocardless-pro" % "3.16.0"
)
