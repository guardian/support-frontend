...
object JsonFixtures {
  ...
  def createContributionZuoraSubscriptionJson(amount: BigDecimal = 5, billingPeriod: BillingPeriod = Monthly): String =
    CreateZuoraSubscriptionState(
      ...
      user(),
      Contribution(amount, GBP, billingPeriod),
      productInformation = Some(ProductInformation("Contribution", "Monthly", Some(amount))),
  ...
  def createSupporterPlusZuoraSubscriptionJson(
    ...
    CreateZuoraSubscriptionState(
      ...
      productInformation = Some(ProductInformation("SupporterPlus", "Monthly", Some(amount))),
      AnalyticsInfo(isGiftPurchase = false, Stripe),
      None,
      None,
      None,
  ...
  def createTierThreeZuoraSubscriptionJson(
    ...
    CreateZuoraSubscriptionState(
      ...
      productInformation = Some(ProductInformation("TierThree", "Monthly", None)),
  ...
  val createDigiPackZuoraSubscriptionJson =
    CreateZuoraSubscriptionState(
      ...
      user(),
      DigitalPack(GBP, Annual),
      productInformation = Some(ProductInformation("DigitalSubscription", "Annual", None)),
      AnalyticsInfo(isGiftPurchase = false, Stripe),
      None,
      None,
      None,
  ...
  val createEverydayPaperSubscriptionJson =
    CreateZuoraSubscriptionState(
      ...
      userJsonWithDeliveryAddress,
      Paper(GBP, Monthly, HomeDelivery, Everyday, None),
      productInformation = Some(ProductInformation("HomeDelivery", "Everyday", None)),
      AnalyticsInfo(isGiftPurchase = false, Stripe),
      None,
      None,
      None,
  ...
  val createEverydayNationalDeliveryPaperSubscriptionJson = {
    ...
    CreateZuoraSubscriptionState(
      ...
      userJsonWithDeliveryAddressOutsideLondon,
      paper,
      productInformation = Some(ProductInformation("NationalDelivery", "Everyday", None)),
      AnalyticsInfo(isGiftPurchase = false, Stripe),
      None,
      None,
      None,
  ...
  def createGuardianWeeklySubscriptionJson(
    ...
    CreateZuoraSubscriptionState(
      ...
      userJsonWithDeliveryAddress,
      GuardianWeekly(GBP, billingPeriod, RestOfWorld),
      productInformation = Some(ProductInformation("GuardianWeeklyRestOfWorld", "Monthly", None)),
      AnalyticsInfo(isGiftPurchase = false, Stripe),
  ...
  val guardianWeeklyGiftJson =
    CreateZuoraSubscriptionState(
      ...
      userJsonWithDeliveryAddress,
      GuardianWeekly(GBP, Quarterly, RestOfWorld),
      productInformation = Some(ProductInformation("GuardianWeeklyRestOfWorld", "Quarterly", None)),
      AnalyticsInfo(isGiftPurchase = false, Stripe),
      Some(LocalDate.now(DateTimeZone.UTC).plusDays(10)),
      None,
      None,
  ...
  val createGuardianAdLiteZuoraSubscriptionJson =
    CreateZuoraSubscriptionState(
      ...
      user(),
      GuardianAdLite(GBP),
      productInformation = Some(ProductInformation("GuardianAdLite", "Monthly", None)),
      AnalyticsInfo(isGiftPurchase = false, Stripe),
      None,
      None,
      None,
