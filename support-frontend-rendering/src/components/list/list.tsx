...
const bulletColours: { [key in ListBulletColour]: SerializedStyles } = {
    light: listItemBulletLight,
    dark: listItemBulletDark,
};

const bulletSizes: { [key in ListBulletSize]: SerializedStyles } = {
...
function ListWith(ListItemComponent: (item: ListItemProps) => React.ReactElement) {
