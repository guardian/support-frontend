...
object GoCardlessConfig {
  ...
  implicit val goCardlessConfigParameterStoreLoadable: ParameterStoreLoadable[Environment, GoCardlessConfig] = new ParameterStoreLoadable[Environment, GoCardlessConfig] {
    ...
    override def decode(paymentApiEnvironment: Environment, data: Map[String, String]): Validated[InitializationError, GoCardlessConfig] = {
      val validator = new ParameterStoreValidator[GoCardlessConfig, Environment](paymentApiEnvironment, data); import validator._
      (
