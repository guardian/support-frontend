...
object CountryGroup {
  ...
  val UK = CountryGroup("United Kingdom", "uk", Some(C.UK), List(
    C.UK,
  ...
  val Australia = CountryGroup("Australia", "au", Some(C.Australia), List(
    C.Australia,
    Country("KI", "Kiribati"),
    Country("NR", "Nauru"),
  ...
  val NewZealand = CountryGroup("New Zealand", "nz", Some(C.NewZealand), List(
    C.NewZealand,
    Country("CK", "Cook Islands")
  ), NZD, PostCode)

  val Europe = CountryGroup("Europe", "eu", None, List(
    Country("AD", "Andorra"),
    Country("AL", "Albania"),
    Country("AT", "Austria"),
  ...
  val RestOfTheWorld = CountryGroup("International", "int", None, List(
