  ...
  return (
    <div className="premium-tier-landing-header">
      <LeftMarginSection modifierClasses={['header-block', 'grey']}>
        <CirclesLeft />
        <CirclesRight />
        <div className="premium-tier-landing-header__picture">
          <GridPicture {...gridPicture(props.countryGroupId)} />
        </div>
        <div className="premium-tier-landing-header__title">
          <div className="premium-tier-landing-header__title-copy">
