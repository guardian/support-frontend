...
function ContributionOnlyBundle(props: PropTypes) {
...
function PartialBundle(props: PropTypes) {
...
export default connect(mapStateToProps, mapDispatchToProps)(PartialBundle);
