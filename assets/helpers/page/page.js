...
import { allTests } from 'helpers/abTests/abtestDefinitions';
...
function statelessInit() {
  ...
  const participations: Participations = abTest.init(country, countryGroupId, allTests);
...
function init<S, A>(
  ...
  const participations: Participations = abTest.init(countryId, countryGroupId, tests);
